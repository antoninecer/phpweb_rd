	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminUsers&amp;action=pjActionCreate" method="post" id="frmCreateUser" class="form pj-form" autocomplete="off">
		...
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input type="text" name="password" id="password" class="pj-form-field required w200" data-msg-required="<?php __('pj_field_required');?>"/>
			</span>
		</p>
		<p>
		...
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				<span class="pj-form-field-before"><abbr class="pj-form-field-icon-phone"></abbr></span>
				<input type="text" name="fax" id="fax" class="pj-form-field w200" placeholder="(123) 456-7890"/>
			</span>
		</p>
		<p>
