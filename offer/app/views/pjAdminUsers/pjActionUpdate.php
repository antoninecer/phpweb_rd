	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminUsers&amp;action=pjActionUpdate" method="post" id="frmUpdateUser" class="form pj-form">
		...
		<p>
			...
			if ((int) $tpl['arr']['id'] !== 1)
			{
				...
				<span class="inline_block">
					<select name="role_id" id="role_id" class="pj-form-field required" data-msg-required="<?php __('pj_field_required');?>">
		...
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input type="text" name="email" id="email" class="pj-form-field required email w200" value="<?php echo pjSanitize::html($tpl['arr']['email']); ?>" data-msg-required="<?php __('pj_field_required');?>" data-msg-required="<?php __('pj_email_invalid');?>"/>
			</span>
		</p>
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input type="text" name="password" id="password" class="pj-form-field required w200" value="<?php echo pjSanitize::html($tpl['arr']['password']); ?>" data-msg-required="<?php __('pj_field_required');?>"/>
			</span>
		</p>
		<p>
		...
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				<span class="pj-form-field-before"><abbr class="pj-form-field-icon-phone"></abbr></span>
				<input type="text" name="fax" id="fax" value="<?php echo pjSanitize::html($tpl['arr']['fax']); ?>" class="pj-form-field w200" placeholder="(123) 456-7890"/>
			</span>
		</p>
		<p>
