	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionForgot" method="post" id="frmForgotAdmin" class="form">
		...
		<p>
			...
			<span class="pj-form-field-custom pj-form-field-custom-before">
				...
				<input type="text" name="forgot_email" id="forgot_email" class="pj-form-field required email w250" data-msg-required="<?php __('pj_field_required');?>" data-msg-email="<?php __('pj_email_invalid');?>"/>
			</span>
		</p>
		<p>
