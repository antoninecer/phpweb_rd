...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice(__('infoFeatureUpdateTitle', true), __('infoFeatureUpdateDesc', true));
	?>
			...
			<p>
				...
				<span class="inline_block">
					<select name="category_id" id="category_id" class="pj-form-field w200">
						...
						{
							?><option value="<?php echo $k; ?>"<?php echo $k == $tpl['arr']['category_id'] ? ' selected="selected"' : null;?>><?php echo stripslashes($v); ?></option><?php
						}
						?>
					</select>
				</span>
