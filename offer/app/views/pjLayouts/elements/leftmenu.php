...
<div class="leftmenu-middle">
	<ul class="menu">
		...
		<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminProperties&amp;action=pjActionIndex" class="<?php echo $_GET['controller'] == 'pjAdminProperties' ? 'menu-focus' : NULL; ?>"><span class="menu-properties">&nbsp;</span><?php __('menuProperties'); ?></a></li>
		<?php
		if ($controller->isAdmin())
		{
			?>
			<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOptions&amp;action=pjActionIndex" class="<?php echo ($_GET['controller'] == 'pjAdminOptions' && in_array($_GET['action'], array('pjActionIndex', 'pjActionPayment', 'pjActionNotification'))) || in_array($_GET['controller'], array('pjAdminFeatures', 'pjAdminTypes', 'pjAdminLocales', 'pjBackup', 'pjLocale', 'pjSms')) ? 'menu-focus' : NULL; ?>"><span class="menu-options">&nbsp;</span><?php __('menuOptions'); ?></a></li>
		...
		if ($controller->isEditor() || $controller->isOwner())
		{
