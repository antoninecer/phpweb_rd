<!doctype html>
<html dir="<?php echo $controller->getDirection();?>">
	<head>
		<title>Property Listing Script by PHPJabbers.com</title>
	...
	<body>
		<div id="container">
    		<div id="header">
				<div id="logo">
					<a href="https://www.phpjabbers.com/property-listing-script/" target="_blank" rel="nofollow">Property Listing Script</a>
