...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice(__('infoTypeCreateTitle', true), __('infoTypeCreateDesc', true));
	?>
	
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminTypes&amp;action=pjActionCreate" method="post" id="frmCreateType" class="pj-form form">
