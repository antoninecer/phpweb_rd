...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice(__('infoTypeUpdateTitle', true), __('infoTypeUpdateDesc', true));
	?>
	
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminTypes&amp;action=pjActionUpdate" method="post" id="frmUpdateTypes" class="form pj-form">
	...
	myLabel.same_type = "<?php __('same_type'); ?>";
	(function ($) {
		$(function() {
			$(".multilang").multilang({
